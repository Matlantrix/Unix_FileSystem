...
class SuperBlock {
private:
	int magic = DEFAULT_MAGIC;     // mark the format of file system
	int num_of_inodes = INODE_NUM; // maximum number of inodes
	int num_of_blocks = BLOCK_NUM; // maximum number of blocks
	int num_of_free_blocks;        // number of free blocks
